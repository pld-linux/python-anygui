...
Celem Anygui jest stworzenie prostego w użyciu, standardowego modułu
do tworzenia interfejsu użytkownika w Pythonie. Główną zaletą Anygui
jest to, że działa on przezroczyście z wieloma innymi GUI na różnych
platformach.
